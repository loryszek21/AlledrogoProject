  ...
  <div className="md:flex-1 px-4">
    ...
    <div className="flex items-center space-x-4 my-4">
      <div>
        ...
        <span className="font-bold dark:text-white text-accentText text-3xl">{product.product_price}</span>
        <span className="text-accentText mr-1 mt-1 dark:text-white">zł</span>
        </div>
      </div>
    </div>
    ...
    <button type="button" className="h-14 px-6 py-2 font-semibold rounded-xl bg-button text-white hover:bg-buttonHover ">
        Add to Cart
      </button>
    </div>
  </div>
